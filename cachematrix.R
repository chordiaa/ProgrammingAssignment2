...
## this function retrieves the inverse from the cache. If not, then
## the 'solve' function is used to inverse the matrix. The matrix inverse
## is then set to the cache
